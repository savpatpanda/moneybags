...
def get_quotes(**kwargs):
	...
	for i in range(len(requested_stocks)):
		quotes.append(float(obj[requested_stocks[i]]['lastPriceInDouble'])) if requested_stocks[i] in obj else quotes.append(None)
		#quotes.append((float(obj[requested_stocks[i]]['bidPriceInDouble']),float(obj[requested_stocks[i]]['askPriceInDouble']),int(obj[requested_stocks[i]]['totalVolume']))) if requested_stocks[i] in obj else quotes.append(None)
	return quotes
